...
INSERT INTO `articulos` VALUES (1,1,'Articulo 1',12.00,2),(2,2,'Articulo 2',20.00,2);
...
CREATE TABLE `categorias` (
  ...
  `descripcion` varchar(45) DEFAULT 'CATEGORYDEFAULT',
...
CREATE TABLE `detallecompra` (
  ...
  CONSTRAINT `idarticulo` FOREIGN KEY (`idarticulo`) REFERENCES `articulos` (`idarticulo`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-02-05 13:12:30
